...
namespace OdeToFood.Areas.Identity.Pages.Account.Manage
{
	public partial class IndexModel : PageModel
	{
		...
		public async Task<IActionResult> OnPostAsync()
		{
			...
			var setRestaurantResult = await _userManager.UpdateAsync(user);
			if (!setRestaurantResult.Succeeded)
			{
				StatusMessage = "Unexpected error when trying to set Favorite Restaurant.";
				return RedirectToPage();
			}
